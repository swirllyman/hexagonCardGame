...
export const ResolutionOverlay: React.FC<ResolutionOverlayProps> = ({
  ...
  return (
    <div className="w-full max-w-xl fantasy-panel rounded-2xl p-3 shadow-2xl flex flex-col items-center gap-2.5 border border-amber-600/40 backdrop-blur-md animate-float">
      ...
      {isClient ? (
        <div className="w-full flex items-center justify-center py-2 bg-slate-950/60 border border-slate-800/60 rounded-xl font-mono text-[10px] text-slate-400 tracking-wider animate-pulse">
          ⏳ Turn execution in progress... Controlled by Host.
        </div>
      ) : (
        /* Control Buttons Bar */
